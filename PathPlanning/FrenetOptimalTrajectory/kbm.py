...
#
# class Car:
#     def __init__(self, x_init, y_init, v_init, theta_init, d_t=0.1, veh_length=0.5, v_max=100.0/3600.0, s_max = 44):
#         self.x_log = [x_init]
#         self.y_log = [y_init]
#         self.v_log = [v_init]
#         self.t_log = [0]
...
#         stear = clip(arctan((rotate_radian - self.)))
#
...
#         d_t=args.dt,from math import cos, sin, tan
from numpy import linalg
import numpy as np
import random
import argparse
...
if __name__ == "__main__":
    ...
    _, diff_x_max, diff_y_max = point2func(t, x, y, args.dim)
